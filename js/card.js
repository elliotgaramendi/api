...
const card = async () => {
  ...
  const [localData, remoteData] = await fetchApi('../json/pokeapi-api-v2-pokemon-25.json', 'https://pokeapi.co/api/v2/pokemon/25');
  
  renderCard(pokemonLocal, localData);
  renderCard(pokemonRemote, remoteData);

  // fetch('../json/pokeapi-api-v2-pokemon-25.json')
  //   .then((response) => {
  ...
  // const pokemonPokemonLocal = await fetchApi('../json/pokeapi-api-v2-pokemon-25.json');
